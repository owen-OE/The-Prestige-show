...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `user_form` SET name = '$update_name', email = '$update_email', country = '$update_country', phone = '$update_phone', occupation = '$update_occupation' WHERE id = '$user_id'") or die('query failed');
...
<head>
   ...
   <title>The Prestige Show | View Profile</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="user_profile.php?logout=<?php echo $user_id; ?>">Logout</a>
        </li>        
      </ul>
    </div>
  </div>
